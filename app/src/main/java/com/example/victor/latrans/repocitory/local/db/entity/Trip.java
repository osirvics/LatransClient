...
//    }
     ...
     * @param posted_on k
     */
    public Trip(long id, String phone_no, long posted_on, long time_updated, String profile_image, String traveling_date, String traveling_from_city, String traveling_from_state, String traveling_to_city, String traveling_to_state, int user_id) {
        super();
        this.id = id;
